...
// Exercice 4
// Insérez votre code ici
let user = [firstname, age, year, birthYear, lastname];
// Ne touchez pas à ceci
...
const car = {
  ...
  yearConstruct: 2019,
  color: " blue",
  image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5cfZD1e0uH0z8BYKpyfH61nkXbE-2OSrFHA&usqp=CAU",
}
// Ne touchez pas à ceci
document.getElementById(
  "firstItem"
...
console.log(output);
output.innerHTML = "<p>bonjour</p><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/800px-JavaScript-logo.png' alt='js logo' />"
// Exercice 9
// Insérez votre code ici
